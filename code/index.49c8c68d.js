 ...
 */const fr=typeof window!="undefined"&&window.customElements!=null&&window.customElements.polyfillWrapFlushCallback!==void 0,ue=(e,t,r=null)=>{for(;t!==r;){const o=t.nextSibling;e.removeChild(t),t=o}},U=`{{lit-${String(Math.random()).slice(2)}}}`,oo=`<!--${U}-->`,mr=new RegExp(`${U}|${oo}`);class no{constructor(t,r){this.parts=[],this.element=r;const o=[],n=[],i=document.createTreeWalker(r.content,133,null,!1);let s=0,d=-1,a=0;const{strings:l,values:{length:u}}=t;for(;a<u;){const c=i.nextNode();if(c!==null){if(d++,c.nodeType===1){if(c.hasAttributes()){const h=c.attributes,{length:p}=h;let f=0;for(let m=0;m<p;m++)vr(h[m].name,"$lit$")&&f++;for(;f-- >0;){const m=l[a],A=pe.exec(m)[2],P=A.toLowerCase()+"$lit$",x=c.getAttribute(P);c.removeAttribute(P);const E=x.split(mr);this.parts.push({type:"attribute",index:d,name:A,strings:E}),a+=E.length-1}}c.tagName==="TEMPLATE"&&(n.push(c),i.currentNode=c.content)}else if(c.nodeType===3){const h=c.data;if(h.indexOf(U)>=0){const p=c.parentNode,f=h.split(mr),m=f.length-1;for(let A=0;A<m;A++){let P,x=f[A];if(x==="")P=B();else{const E=pe.exec(x);E!==null&&vr(E[2],"$lit$")&&(x=x.slice(0,E.index)+E[1]+E[2].slice(0,-5)+E[3]),P=document.createTextNode(x)}p.insertBefore(P,c),this.parts.push({type:"node",index:++d})}f[m]===""?(p.insertBefore(B(),c),o.push(c)):c.data=f[m],a+=m}}else if(c.nodeType===8)if(c.data===U){const h=c.parentNode;c.previousSibling!==null&&d!==s||(d++,h.insertBefore(B(),c)),s=d,this.parts.push({type:"node",index:d}),c.nextSibling===null?c.data="":(o.push(c),d--),a++}else{let h=-1;for(;(h=c.data.indexOf(U,h+1))!==-1;)this.parts.push({type:"node",index:-1}),a++}}else i.currentNode=n.pop()}for(const c of o)c.parentNode.removeChild(c)}}const vr=(e,t)=>{const r=e.length-t.length;return r>=0&&e.slice(r)===t},io=e=>e.index!==-1,B=()=>document.createComment(""),pe=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function gr(e,t){const{element:{content:r},parts:o}=e,n=document.createTreeWalker(r,133,null,!1);let i=ct(o),s=o[i],d=-1,a=0;const l=[];let u=null;for(;n.nextNode();){d++;const c=n.currentNode;for(c.previousSibling===u&&(u=null),t.has(c)&&(l.push(c),u===null&&(u=c)),u!==null&&a++;s!==void 0&&s.index===d;)s.index=u!==null?-1:s.index-a,i=ct(o,i),s=o[i]}l.forEach(c=>c.parentNode.removeChild(c))}const zn=e=>{let t=e.nodeType===11?0:1;const r=document.createTreeWalker(e,133,null,!1);for(;r.nextNode();)t++;return t},ct=(e,t=-1)=>{for(let r=t+1;r<e.length;r++){const o=e[r];if(io(o))return r}return-1};/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const Fn=new WeakMap,bt=e=>typeof e=="function"&&Fn.has(e),N={},br={};/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */class fe{constructor(t,r,o){this.__parts=[],this.template=t,this.processor=r,this.options=o}update(t){let r=0;for(const o of this.__parts)o!==void 0&&o.setValue(t[r]),r++;for(const o of this.__parts)o!==void 0&&o.commit()}_clone(){const t=fr?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),r=[],o=this.template.parts,n=document.createTreeWalker(t,133,null,!1);let i,s=0,d=0,a=n.nextNode();for(;s<o.length;)if(i=o[s],io(i)){for(;d<i.index;)d++,a.nodeName==="TEMPLATE"&&(r.push(a),n.currentNode=a.content),(a=n.nextNode())===null&&(n.currentNode=r.pop(),a=n.nextNode());if(i.type==="node"){const l=this.processor.handleTextExpression(this.options);l.insertAfterNode(a.previousSibling),this.__parts.push(l)}else this.__parts.push(...this.processor.handleAttributeExpressions(a,i.name,i.strings,this.options));s++}else this.__parts.push(void 0),s++;return fr&&(document.adoptNode(t),customElements.upgrade(t)),t}}/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const Wn=` ${U} `;class so{constructor(t,r,o,n){this.strings=t,this.values=r,this.type=o,this.processor=n}getHTML(){const t=this.strings.length-1;let r="",o=!1;for(let n=0;n<t;n++){const i=this.strings[n],s=i.lastIndexOf("<!--");o=(s>-1||o)&&i.indexOf("-->",s+1)===-1;const d=pe.exec(i);r+=d===null?i+(o?Wn:oo):i.substr(0,d.index)+d[1]+d[2]+"$lit$"+d[3]+U}return r+=this.strings[t],r}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const Ae=e=>e===null||!(typeof e=="object"||typeof e=="function"),ao=e=>Array.isArray(e)||!(!e||!e[Symbol.iterator]);class lo{constructor(t,r,o){this.dirty=!0,this.element=t,this.name=r,this.strings=o,this.parts=[];for(let n=0;n<o.length-1;n++)this.parts[n]=this._createPart()}_createPart(){return new co(this)}_getValue(){const t=this.strings,r=t.length-1;let o="";for(let n=0;n<r;n++){o+=t[n];const i=this.parts[n];if(i!==void 0){const s=i.value;if(Ae(s)||!ao(s))o+=typeof s=="string"?s:String(s);else for(const d of s)o+=typeof d=="string"?d:String(d)}}return o+=t[r],o}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class co{constructor(t){this.value=void 0,this.committer=t}setValue(t){t===N||Ae(t)&&t===this.value||(this.value=t,bt(t)||(this.committer.dirty=!0))}commit(){for(;bt(this.value);){const t=this.value;this.value=N,t(this)}this.value!==N&&this.committer.commit()}}class zt{constructor(t){this.value=void 0,this.__pendingValue=void 0,this.options=t}appendInto(t){this.startNode=t.appendChild(B()),this.endNode=t.appendChild(B())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t.__insert(this.startNode=B()),t.__insert(this.endNode=B())}insertAfterPart(t){t.__insert(this.startNode=B()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this.__pendingValue=t}commit(){if(this.startNode.parentNode===null)return;for(;bt(this.__pendingValue);){const r=this.__pendingValue;this.__pendingValue=N,r(this)}const t=this.__pendingValue;t!==N&&(Ae(t)?t!==this.value&&this.__commitText(t):t instanceof so?this.__commitTemplateResult(t):t instanceof Node?this.__commitNode(t):ao(t)?this.__commitIterable(t):t===br?(this.value=br,this.clear()):this.__commitText(t))}__insert(t){this.endNode.parentNode.insertBefore(t,this.endNode)}__commitNode(t){this.value!==t&&(this.clear(),this.__insert(t),this.value=t)}__commitText(t){const r=this.startNode.nextSibling,o=typeof(t=t==null?"":t)=="string"?t:String(t);r===this.endNode.previousSibling&&r.nodeType===3?r.data=o:this.__commitNode(document.createTextNode(o)),this.value=t}__commitTemplateResult(t){const r=this.options.templateFactory(t);if(this.value instanceof fe&&this.value.template===r)this.value.update(t.values);else{const o=new fe(r,t.processor,this.options),n=o._clone();o.update(t.values),this.__commitNode(n),this.value=o}}__commitIterable(t){Array.isArray(this.value)||(this.value=[],this.clear());const r=this.value;let o,n=0;for(const i of t)o=r[n],o===void 0&&(o=new zt(this.options),r.push(o),n===0?o.appendIntoPart(this):o.insertAfterPart(r[n-1])),o.setValue(i),o.commit(),n++;n<r.length&&(r.length=n,this.clear(o&&o.endNode))}clear(t=this.startNode){ue(this.startNode.parentNode,t.nextSibling,this.endNode)}}class qn{constructor(t,r,o){if(this.value=void 0,this.__pendingValue=void 0,o.length!==2||o[0]!==""||o[1]!=="")throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=r,this.strings=o}setValue(t){this.__pendingValue=t}commit(){for(;bt(this.__pendingValue);){const r=this.__pendingValue;this.__pendingValue=N,r(this)}if(this.__pendingValue===N)return;const t=!!this.__pendingValue;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=t),this.__pendingValue=N}}class Kn extends lo{constructor(t,r,o){super(t,r,o),this.single=o.length===2&&o[0]===""&&o[1]===""}_createPart(){return new Jn(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class Jn extends co{}let ho=!1;(()=>{try{const e={get capture(){return ho=!0,!1}};window.addEventListener("test",e,e),window.removeEventListener("test",e,e)}catch{}})();class Gn{constructor(t,r,o){this.value=void 0,this.__pendingValue=void 0,this.element=t,this.eventName=r,this.eventContext=o,this.__boundHandleEvent=n=>this.handleEvent(n)}setValue(t){this.__pendingValue=t}commit(){for(;bt(this.__pendingValue);){const i=this.__pendingValue;this.__pendingValue=N,i(this)}if(this.__pendingValue===N)return;const t=this.__pendingValue,r=this.value,o=t==null||r!=null&&(t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive),n=t!=null&&(r==null||o);o&&this.element.removeEventListener(this.eventName,this.__boundHandleEvent,this.__options),n&&(this.__options=Yn(t),this.element.addEventListener(this.eventName,this.__boundHandleEvent,this.__options)),this.value=t,this.__pendingValue=N}handleEvent(t){typeof this.value=="function"?this.value.call(this.eventContext||this.element,t):this.value.handleEvent(t)}}const Yn=e=>e&&(ho?{capture:e.capture,passive:e.passive,once:e.once}:e.capture);function Xn(e){let t=_t.get(e.type);t===void 0&&(t={stringsArray:new WeakMap,keyString:new Map},_t.set(e.type,t));let r=t.stringsArray.get(e.strings);if(r!==void 0)return r;const o=e.strings.join(U);return r=t.keyString.get(o),r===void 0&&(r=new no(e,e.getTemplateElement()),t.keyString.set(o,r)),t.stringsArray.set(e.strings,r),r}const _t=new Map,W=new WeakMap;/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const Zn=new class{handleAttributeExpressions(e,t,r,o){const n=t[0];return n==="."?new Kn(e,t.slice(1),r).parts:n==="@"?[new Gn(e,t.slice(1),o.eventContext)]:n==="?"?[new qn(e,t.slice(1),r)]:new lo(e,t,r).parts}handleTextExpression(e){return new zt(e)}};/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
...
*/const vo="adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,go=Symbol();class _r{constructor(t,r){if(r!==go)throw new Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t}get styleSheet(){return this._styleSheet===void 0&&(vo?(this._styleSheet=new CSSStyleSheet,this._styleSheet.replaceSync(this.cssText)):this._styleSheet=null),this._styleSheet}toString(){return this.cssText}}const oi=(e,...t)=>{const r=t.reduce((o,n,i)=>o+(s=>{if(s instanceof _r)return s.cssText;if(typeof s=="number")return s;throw new Error(`Value passed to 'css' function must be a 'css' function result: ${s}. Use 'unsafeCSS' to pass non-literal values, but
            take care to ensure page security.`)})(n)+e[i+1],e[0]);return new _r(r,go)};/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var be=class extends Et{constructor(){super(...arguments);this.hasSlotController=new So(this,"footer","header","image")}render(){return Pe`
      <div
        part="base"
    ...
    `}};be.styles=bi;be=v([Oe("sl-card")],be);var Oi=Ft`
  ${ke}
...
`,ye=class extends Et{constructor(){super(...arguments);this.localize=new To(this)}render(){return Pe`
      <svg part="base" class="spinner" role="progressbar" aria-valuetext=${this.localize.term("loading")}>
        <circle class="spinner__track"></circle>
        <circle class="spinner__indicator"></circle>
      </svg>
    `}};ye.styles=Vi;ye=v([Oe("sl-spinner")],ye);const zi=It`
...
`;var Fi=Object.defineProperty,Wi=Object.getOwnPropertyDescriptor,Ne=(e,t,r,o)=>{for(var n=o>1?void 0:o?Wi(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(n=(o?s(t,r,n):s(n))||n);return o&&n&&Fi(t,r,n),n};let Dt=class extends V{constructor(){super();this.message="Welcome!",this.test="Test",setInterval(()=>{this.test=new Date().toString();const e=new Request("https://localhost:7216/api/WeatherForecast");fetch(e).then(t=>{console.log(t)}).catch(t=>{console.error(t)})},1e3)}static get styles(){return[zi,It`
      #welcomeBar {
        display: flex;
        justify-content: center;
        align-items: center;
    ...
    `]}async firstUpdated(){console.log("This is your home page")}share(){navigator.share&&navigator.share({title:"PWABuilder pwa-starter",text:"Check out the PWABuilder pwa-starter!",url:"https://github.com/pwa-builder/pwa-starter"})}render(){return mt`
      ...
      <main>
        <div id="welcomeBar">
          ...
          <sl-button href="${"/pwa-starter/"}about" variant="primary">Navigate to About</sl-button>
        </div>

        <pwa-install>Install PWA Starter</pwa-install>
      </main>
    `}};Ne([Vt()],Dt.prototype,"message",2);Ne([Vt()],Dt.prototype,"test",2);Dt=Ne([Se("app-home")],Dt);var qi=Object.defineProperty,Ki=Object.getOwnPropertyDescriptor,Re=(e,t,r,o)=>{for(var n=o>1?void 0:o?Ki(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(n=(o?s(t,r,n):s(n))||n);return o&&n&&qi(t,r,n),n};let Ht=class extends V{constructor(){super();this.title="PWA Starter",this.enableBack=!1}static get styles(){return It`
      header {
        display: flex;
        justify-content: space-between;
        align-items: center;
    ...
    `}render(){return mt`
      <header>
        ...
        <div id="back-button-block">
          ${this.enableBack?mt`<sl-button href="${"/pwa-starter/"}">
            Back
          </sl-button>`:null}
    ...
    `}};Re([Vt({type:String})],Ht.prototype,"title",2);Re([Vt({type:Boolean})],Ht.prototype,"enableBack",2);Ht=Re([Se("app-header")],Ht);var Ji=Object.defineProperty,Gi=Object.getOwnPropertyDescriptor,Yi=(e,t,r,o)=>{for(var n=o>1?void 0:o?Gi(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(n=(o?s(t,r,n):s(n))||n);return o&&n&&Ji(t,r,n),n};let Hr=class extends V{static get styles(){return It`
      main {
        padding-left: 16px;
        padding-right: 16px;
        padding-bottom: 16px;
    ...
    `}constructor(){super()}firstUpdated(){var t;new H((t=this.shadowRoot)==null?void 0:t.querySelector("#routerOutlet")).setRoutes([{path:"/pwa-starter/",animate:!0,children:[{path:"",component:"app-home"},{path:"about",component:"app-about",action:async()=>{await Vo(()=>import("./app-about.c0a3c392.js"),[])}}]}])}render(){return mt`
      <div>
        <main>
          <div id="routerOutlet"></div>
        </main>
      </div>
    `}};Hr=Yi([Se("app-index")],Hr);export{zi as a,Se as e,It as i,V as s,mt as y};
//# sourceMappingURL=index.49c8c68d.js.map
