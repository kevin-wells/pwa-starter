...
`;var Fi=Object.defineProperty,Wi=Object.getOwnPropertyDescriptor,Tn=(e,t,r,n)=>{for(var o=n>1?void 0:n?Wi(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(n?s(t,r,o):s(o))||o);return n&&o&&Fi(t,r,o),o};let _e=class extends V{constructor(){super();this.message="Welcome!"}static get styles(){return[zi,Ht`
    ...
    `}constructor(){super()}firstUpdated(){var t;new H((t=this.shadowRoot)==null?void 0:t.querySelector("#routerOutlet")).setRoutes([{path:"/pwa-starter/",animate:!0,children:[{path:"",component:"app-home"},{path:"about",component:"app-about",action:async()=>{await Vn(()=>import("./app-about.e9ebbc0c.js"),[])}}]}])}render(){return mt`
      <div>
        <main>
...
//# sourceMappingURL=index.0797d907.js.map
